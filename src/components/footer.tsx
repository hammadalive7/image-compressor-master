const ClaudeLogo = () => (
  <svg fill="none" viewBox="0 -.01 39.5 39.53" className="h-3.5 w-3.5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" aria-label="Claude">
...
const Footer = () => {
  return (
    <footer className="mt-auto border-t border-border bg-surface py-5">
